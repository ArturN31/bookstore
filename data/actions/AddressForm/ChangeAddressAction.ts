...
export type ChangeAddressFormState = {
...
const schema = z.object({
	...
	postcode: z
		...
		.regex(
			/^[A-Za-z0-9]{3,10}$/,
			'Postcode must be alphanumeric and between 3-10 characters',
		),
	city: z
		.string()
		.trim()
...
export async function ChangeAddressAction(
	prevState: ChangeAddressFormState | undefined,
	formData: FormData,
): Promise<ChangeAddressFormState> {
