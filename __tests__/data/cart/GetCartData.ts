...
describe('GetCartData', () => {
    ...
    describe('getUsersCartID', () => {
        ...
        it('should return cart ID when found', async () => {
            (Repo.findCartIdByUserId as jest.Mock).mockResolvedValue({ data: { id: 'cart-123' }, error: null });
    ...
    describe('createUsersCart', () => {
        ...
        it('should create cart and return ID', async () => {
            (Repo.createCart as jest.Mock).mockResolvedValue({ data: { id: 'new-cart' }, error: null });
    ...
    describe('getCartData', () => {
        ...
        it('should return cart data with books', async () => {
            ...
            (Repo.fetchFullCartWithBooks as jest.Mock).mockResolvedValue({ data: mockCartData, error: null });
            (mapDatabaseCartToDomain as jest.Mock).mockReturnValue({ cartID: 'cart-123', books: [] });
        ...
        it('should handle connection timeout', async () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith('[CartService] Pipeline Error:', expect.any(Error));
