export default function TOS() {
	return (
		<div className='grid gap-2'>
			...
			<p>
				By accessing or using this website, Books 4 You (the "Website"), or any of our
				services (collectively, the "Services"), you agree to be bound by these Terms of
			...
			<p>
				...
				access to your computer. You agree to accept responsibility for all activities
			...
			<p>
				<span className='font-semibold'>Availability:</span> Product availability may
				change without notice. We reserve the right to limit or cancel orders due to
				product availability or other reasons.
			</p>
			...
			<p>
				...
				acceptance by us. We may, in our sole discretion, refuse or cancel any order for
				any reason.
			</p>
			<p>
				<span className='font-semibold'>Payment:</span> You agree to pay all charges
				incurred by you or any users of your account at the rates in effect when the
				charges are incurred. We accept various payment methods, as indicated on the
				Website.
			</p>
			<p>
				<span className='font-semibold'>Taxes:</span> You are responsible for any
				applicable taxes, including sales tax, on your orders.
			</p>

			<h2 className='font-bold'>5. Shipping and Delivery</h2>
			<p>
				<span className='font-semibold'>Shipping Costs:</span> Shipping costs are
				calculated based on the shipping method selected and the destination address.
			</p>
			<p>
				<span className='font-semibold'>Delivery Times:</span> Estimated delivery times
				are provided for your convenience and are not guaranteed.
			</p>
			<p>
			...
			<p>
				...
				displayed on the Website are the property of Books 4 You or their respective
				owners.
			</p>

			<h2 className='font-bold'>8. Disclaimer of Warranties</h2>
			<p>
				THE WEBSITE AND SERVICES ARE PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTY
			...
			<p>
				...
				SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES ARISING OUT OF OR RELATING TO THE USE
				OF THE WEBSITE OR SERVICES, INCLUDING, BUT NOT LIMITED TO, LOSS OF PROFITS, DATA
				LOSS, OR LOSS OF GOODWILL.
			</p>

			<h2 className='font-bold'>10. Indemnification</h2>
			<p>
				You agree to indemnify and hold Books 4 You and its affiliates, officers,
				directors, employees, and agents harmless from any and all claims, liabilities,
				damages, and expenses (including attorneys' fees) arising out of your use of the
				Website or Services, your violation of these Terms, or your violation of any
				rights of another.
			</p>
